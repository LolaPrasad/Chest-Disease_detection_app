...
```bash
export MLFLOW_TRACKING_URI=https://dagshub.com/LolaPrasad/Chest-Disease_detection_app.mlflow
...
AWS_ECR_LOGIN_URI = demo>>  008971652357.dkr.ecr.us-east-1.amazonaws.com
